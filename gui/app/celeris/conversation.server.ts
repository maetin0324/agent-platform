 ...
 * docs/celeris-api-v1.md §3.54〜3.55）の中継。
 ...
 * - GUI 側では検証しない: celeris が 401 / 404 / 422 を返したらその文言をそのまま出す。
 */
...
export async function loadConversation(
  ...
  // （そのまま送ると celeris が 404 `project_not_found` を返す。ULID でない文字列だから）。
 ...
 * （docs/celeris-api-v1.md §3.46「省略すれば従来どおり作業場所なし」）。
 */
